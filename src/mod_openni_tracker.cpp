...
void publishTransform(XnUserID const& user, XnSkeletonJoint const& joint, string const& frame_id, string const& child_frame_id) {
    ...
    snprintf(child_frame_no, sizeof(child_frame_no), "%s_%d", child_frame_id.c_str(), 1);////*******user to 1**** 
...
int main(int argc, char **argv) {
    ros::init(argc, argv, "mod_openni_tracker");
    ros::NodeHandle nh;

    string configFilename = ros::package::getPath("mod_openni_tracker") + "/openni_tracker.xml";
